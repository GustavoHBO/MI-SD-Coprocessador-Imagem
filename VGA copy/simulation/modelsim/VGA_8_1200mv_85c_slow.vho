...
-- Equation(s):
-- \hvsync|Equal0~1_combout\ = (\hvsync|CounterX\(5) & (!\hvsync|CounterX\(4) & (!\hvsync|CounterX\(6) & !\hvsync|CounterX\(7))))
...
-- Equation(s):
-- \always2~1_combout\ = (\hvsync|CounterY\(7)) # ((\hvsync|CounterY\(8)) # ((\hvsync|CounterY\(6)) # (\always2~0_combout\)))
...
-- Equation(s):
-- \pixel~0_combout\ = (\controlador_ram|altsyncram_component|auto_generated|q_b\(0) & (\hvsync|inDisplayArea~q\ & !\always2~1_combout\))
...
-- Equation(s):
-- \pixel~1_combout\ = (\hvsync|inDisplayArea~q\ & ((\controlador_ram|altsyncram_component|auto_generated|q_b\(0)) # (\always2~1_combout\)))
...
-- Equation(s):
-- \hvsync|vga_VS~0_combout\ = ((\hvsync|CounterY\(2)) # ((!\hvsync|CounterY\(1)) # (!\hvsync|CounterY\(0)))) # (!\hvsync|CounterY\(3))
