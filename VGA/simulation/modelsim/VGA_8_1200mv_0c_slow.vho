...
-- datab	=>  Location: PIN_E10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \hvsync|Equal0~1_combout\ = (\hvsync|CounterX\(5) & (!\hvsync|CounterX\(7) & (!\hvsync|CounterX\(4) & !\hvsync|CounterX\(6))))
...
-- pragma translate_on
PORT MAP (
	datab => \Escrever|wraddress\(10),
	datac => \Escrever|state.enviar_dado~clkctrl_outclk\,
	datad => \Escrever|contador\(10),
...
-- Equation(s):
-- \always1~1_combout\ = (\hvsync|CounterY\(6)) # ((\hvsync|CounterY\(8)) # ((\hvsync|CounterY\(7)) # (\always1~0_combout\)))
