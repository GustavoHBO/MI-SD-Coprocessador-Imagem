...
-- leds[0]	=>  Location: PIN_D5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- leds[1]	=>  Location: PIN_T2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- leds[2]	=>  Location: PIN_A13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- leds[3]	=>  Location: PIN_R8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
& \~GND~combout\ & \~GND~combout\ & \~GND~combout\ & \~GND~combout\ & \~GND~combout\ & \~GND~combout\ & \Escrever|state.FIM~_wirecell_combout\);

\controlador_ram|altsyncram_component|auto_generated|ram_block1a0_PORTAADDR_bus\ <= (\Escrever|wraddress\(6) & \Escrever|wraddress\(5) & \Escrever|wraddress\(4) & \Escrever|wraddress\(3) & \Escrever|wraddress\(2) & \Escrever|wraddress\(1) & 
\Escrever|wraddress\(0));
...
-- Equation(s):
-- \hvsync|Equal0~0_combout\ = (!\hvsync|CounterX\(2) & (!\hvsync|CounterX\(0) & (!\hvsync|CounterX\(1) & !\hvsync|CounterX\(3))))
...
-- Equation(s):
-- \Escrever|LessThan0~0_combout\ = (\Escrever|contador\(10)) # ((\Escrever|contador\(8)) # ((\Escrever|contador\(7)) # (\Escrever|contador\(9))))
...
-- Equation(s):
-- \Escrever|LessThan0~1_combout\ = (\Escrever|contador\(11)) # (\Escrever|LessThan0~0_combout\)
...
PORT MAP (
	...
	sclr => \Escrever|LessThan0~1_combout\,
...
-- Equation(s):
-- \Escrever|contador[11]~34_combout\ = \Escrever|contador\(11) $ (\Escrever|contador[10]~33\)
...
-- Equation(s):
-- \Escrever|state.FIM~0_combout\ = (\Escrever|contador\(11)) # ((\Escrever|state.FIM~q\) # (\Escrever|LessThan0~0_combout\))
...
PORT MAP (
	clk => \clk~inputclkctrl_outclk\,
	asdata => \Escrever|state.FIM~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datac => \Escrever|state.FIM~clkctrl_outclk\,
...
-- Equation(s):
-- \always1~0_combout\ = (\hvsync|CounterX\(8)) # ((\hvsync|CounterX\(6)) # ((\hvsync|CounterX\(9)) # (\hvsync|CounterX\(7))))
...
-- Equation(s):
-- \hvsync|vga_HS~0_combout\ = (\hvsync|CounterX\(5) & (((!\hvsync|CounterX\(4))) # (!\hvsync|CounterX\(6)))) # (!\hvsync|CounterX\(5) & ((\hvsync|CounterX\(6)) # ((!\hvsync|Equal0~0_combout\ & \hvsync|CounterX\(4)))))
