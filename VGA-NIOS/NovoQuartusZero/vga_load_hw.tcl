...
# Tue Aug 07 21:17:28 BRT 2018
# DO NOT MODIFY


# 
# vga_load "vga_load" v1.0
#  2018.08.07.21:17:28
# 
# 
...
set_module_property NAME vga_load
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME vga_load
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL VGADemo
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file VGADemo.v VERILOG PATH VGADemo.v TOP_LEVEL_FILE
add_fileset_file ccpu_ram.v VERILOG PATH ccpu_ram.v
add_fileset_file controlador_ram.v VERILOG PATH controlador_ram.v
add_fileset_file divisor_clock.v VERILOG PATH divisor_clock.v
add_fileset_file Escrever.v VERILOG PATH Escrever.v
add_fileset_file hsync_generator.v VERILOG PATH hsync_generator.v
add_fileset_file image.hex HEX PATH image.hex
...
add_interface_port conduit_end_1 pixel pixel Output 3
...
add_interface_port conduit_end_2 hsync_out hsync Output 1
...
add_interface_port conduit_end_3 vsync_out vsync Output 1
